...
class VM_Info:
	...
	def __init__(self, name):
		...
		self.name = name
		self.attributes = {}
		self.keys = set(['Used', 'User', 'System', 'Nice', 'Idle', 'IOwait', 'Irq', 'Softirq', 'Total', 'Pagefault', 'Swapin', 'Swapout', 'Allocated', 'Min', 'Configured'])
	...
	def initAttribute(self, guest):
		...
		self.setAttribute('Configured', 4096000)
		self.update(guest)
